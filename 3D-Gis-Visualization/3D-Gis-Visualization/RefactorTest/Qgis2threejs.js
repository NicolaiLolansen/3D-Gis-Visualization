...
(function () {
  ...
  app.init = function (container) {
    ...
    app.scene.fog = new THREE.Fog(0xffffff, 0.1, 900);
        ...
        if (response.features.length > 0) {
            ...
            for (var i = 0; i < response.features.length; i++) {
                ...
                if (response.features[i].geometry.type == "Point" || response.features[i].geometry.type == "MultiPoint") {
                    ...
                    if (project.WFSlayers[0].a[i].betalingszone == "Grøn") {
                        color = 0x00ff00;
                    } else if (project.WFSlayers[0].a[i].betalingszone == "Rød") {
                        color = 0xff0000;
                    } else if (project.WFSlayers[0].a[i].betalingszone == "Blå") {
                        color = 0x0000ff;
                    } else if (project.WFSlayers[0].a[i].betalingszone == null) {
                        color = 0xffffff;
                    }
