...
(function () {
    ...
    app.init = function (container) {
        ...
        //Load project
        app.loadProject(new Q3D.Project({ crs: "EPSG:25832", wgs84Center: { lat: 55.6712168922, lon: 12.4893929063 }, proj: "+proj=utm +zone=32 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", title: "test", baseExtent: [721552, 6172845, 731412, 6179108], rotation: 0, zShift: 0.0, width: 500.0, zExaggeration: 0.0 }));
    ...
    app.generateTerrain = function (url, height, width) {
        ...
        img.onload = function () {
            ...
            /*     var l = plane.faces.length / 2; // divided by 2 because each tile consists two triangles, which is two faces.
                 for (var i = 0; i < l; i++) {
