...
(function () {
  ...
  app.calculatebbox = function (num) {
     ...
     var url = "http://kortforsyningen.kms.dk/service?servicename=orto_foraar&request=GetMap&service=WMS&version=1.1.1&LOGIN=Bydata&PASSWORD=Qby2016%21&layers=orto_foraar&width=512&height=256&format=image%2Fpng&srs=EPSG%3A25832"
     ...
     //var leftSide = materials.splice(0, materials.length / 2);
     //var rightSide = materials.splice((materials.length / 2) + 1, materials.length);
     //leftSide.reverse();
     //rightSide.reverse();

     //materials = leftSide.concat(rightSide);
     //materials.reverse();
   ...
   //  var planemesh = THREE.SceneUtils.createMultiMaterialObject(plane, materials);
    ...
    // planemesh.position.z = 3;
     ...
     //console.log(planemesh);
      ...
      //Update the resolution afterwards?
